...
const mint = [
  {
    ...
    availability: 3000,
    nft: [
      "1/1 Still image of a frame from the film, music camp or bts documentary",
    ],
    benefit: [
    ...
    <div className="container">
      <div className={classes.section}>
        ...
        <p className={classes.text}>
          Romi studios is building a virtual screening room for all our titles.
          NFTs from this mint would grant its holders access to this.
        </p>
      </div>
    </div>
  );
